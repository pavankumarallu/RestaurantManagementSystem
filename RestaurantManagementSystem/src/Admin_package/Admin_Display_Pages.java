...
public class Admin_Display_Pages extends JFrame {
	...
	public Admin_Display_Pages() throws ClassNotFoundException, InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
		...
		layeredPane.setBounds(0, 115, 1050, 534);
		...
		menuitem_display.setBounds(121, 44, 808, 457);
...
//		
		...
		scrollPane.setBounds(62, 49, 927, 222);
...
//		}
		...
		Item_id.setBounds(699, 314, 163, 26);
		...
		Item_name.setBounds(699, 350, 163, 26);
		...
		Item_Price.setBounds(699, 386, 163, 26);
		...
		item_Quantity.setBounds(699, 422, 163, 26);
		...
		Item_Review.setBounds(699, 457, 163, 26);
		...
		add_btn.setBounds(79, 415, 317, 54);
		...
		delete_btn.setBounds(79, 333, 317, 54);
		...
		lblNewLabel_1.setBounds(487, 349, 99, 26);
		...
		lblNewLabel_1_1.setBounds(487, 384, 99, 26);
		...
		lblNewLabel_1_2.setBounds(487, 421, 122, 26);
		...
		lblNewLabel_1_3.setBounds(487, 456, 122, 26);
		...
		lblNewLabel_1_4.setBounds(487, 313, 99, 26);
		...
		MenuCard_display_btn.setBounds(356, 29, 179, 48);
		...
		Editmenu_btn.setBackground(Color.ORANGE);
		Editmenu_btn.setBounds(588, 29, 179, 48);
		...
		Display_cust_btn.setBackground(Color.ORANGE);
		Display_cust_btn.setBounds(823, 29, 179, 48);
		...
		lblNewLabel.setBounds(55, 29, 234, 48);
